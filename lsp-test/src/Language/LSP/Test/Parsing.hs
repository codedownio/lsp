...
message :: (MonadLoggerIO n, MonadUnliftIO n) => SServerMethod m -> Session n (TServerMessage m)
...
isLogNotification (FromServerMess SMethod_WindowShowMessageRequest _) = True
