...
message :: MonadLoggerIO n => SServerMethod m -> Session n (TMessage m)
...
customRequest :: (MonadLoggerIO m, KnownSymbol s) => Proxy s -> Session m (TMessage (Method_CustomMethod s :: Method ServerToClient Request))
customRequest p =
...
customNotification :: (MonadLoggerIO m, KnownSymbol s) => Proxy s -> Session m (TMessage (Method_CustomMethod s :: Method ServerToClient Notification))
...
response :: MonadLoggerIO n => SMethod (m :: Method ClientToServer Request) -> Session n (TResponseMessage m)
...
responseForId :: MonadLoggerIO n => SMethod (m :: Method ClientToServer Request) -> LspId m -> Session n (TResponseMessage m)
...
publishDiagnosticsNotification :: MonadLoggerIO m => Session m (TMessage Method_TextDocumentPublishDiagnostics)
